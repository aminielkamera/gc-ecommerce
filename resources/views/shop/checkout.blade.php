    ...
    <div class="container">
        ...
        <div id="shopCartAccordion" class="accordion rounded mb-5">
            ...
            <div class="card border-0">
                <div id="shopCartHeadingOne" class="alert text-white-90 alert-primary mb-0" role="alert">
                    Returning customer? <a href="#" class="text-white-90" data-toggle="collapse" data-target="#shopCartOne" aria-expanded="false" aria-controls="shopCartOne">Click here to login</a>
                </div>
                            ...
                            <div class="p-4 mb-4 checkout-table">
                                ...
                                <table class="table">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <th>Shipping</th>
                                            <td>Flat rate Tsh300.00</td>
                                        </tr>
                                        <tr>
                                            <th>Total</th>
                                            <td><strong>Tsh2,085.00</strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                                <!-- End Product Content -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="js-form-message mb-6">
                                    ...
                                    <select class="form-control js-select selectpicker dropdown-select" required="" data-msg="Please select state." data-error-class="u-has-error" data-success-class="u-has-success" data-live-search="true" data-style="form-control border-color-1 font-weight-normal">
