            ...
            <div class="my-md-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                        ...
                        <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">Hard Disk</li>
                    </ol>
                </nav>
            </div>
            <!-- End breadcrumb -->
        ...
        <div class="row mb-8">
            <div class="col-xl-12 col-wd-9gdot5">
                ...
                <div class="mb-6 d-none d-xl-block">
                    <div class="position-relative">
                        <div class="border-bottom border-color-1 mb-2">
                            <h3 class="d-inline-block section-title section-title__full mb-0 pb-2 font-size-22">New Arrivals Hard Disk</h3>
                        </div>
                ...
                <div class="flex-center-between mb-3">
                    <h3 class="font-size-25 mb-0">Hard Disk</h3>
