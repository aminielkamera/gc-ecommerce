            ...
            <div class="row">
                <div class="col-md-5 mb-4 mb-md-0">
                    <div id="sliderSyncingNav" class="js-slick-carousel u-slick mb-2" data-infinite="true" data-arrows-classes="d-none d-lg-inline-block u-slick__arrow-classic u-slick__arrow-centered--y rounded-circle" data-arrow-left-classes="fas fa-arrow-left u-slick__arrow-classic-inner u-slick__arrow-classic-inner--left ml-lg-2 ml-xl-4" data-arrow-right-classes="fas fa-arrow-right u-slick__arrow-classic-inner u-slick__arrow-classic-inner--right mr-lg-2 mr-xl-4" data-nav-for="#sliderSyncingThumb">
                        <div class="js-slide">
                            <img class="img-fluid" src="{{ asset('assets/img/720X660/img1.jpg')}}" alt="Image Description">
                        </div>
                        <div class="js-slide">
                            <img class="img-fluid" src="{{ asset('assets/img/720X660/img2.jpg')}}" alt="Image Description">
                        </div>
                        <div class="js-slide">
                            <img class="img-fluid" src="{{ asset('assets/img/720X660/img3.jpg')}}" alt="Image Description">
                        </div>
                        <div class="js-slide">
                            <img class="img-fluid" src="{{ asset('assets/img/720X660/img4.jpg')}}" alt="Image Description">
                        </div>
                        <div class="js-slide">
                            <img class="img-fluid" src="{{ asset('assets/img/720X660/img5.jpg')}}" alt="Image Description">
                        </div>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-baseline">
                                <ins class="font-size-36 text-decoration-none">Tsh1,999.00</ins>
                                <del class="font-size-20 ml-2 text-gray-6">Tsh2,299.00</del>
                            </div>
                        </div>
                        ...
                        <div class="d-md-flex align-items-end mb-3">
                            ...
                            <div class="ml-md-3">
                                <a href="{{url('shop/cart')}}" class="btn px-5 btn-primary-dark transition-3d-hover"><i class="ec ec-add-to-cart mr-2 font-size-20"></i> Add to Cart</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tab-pane fade active show" id="Jpills-one-example1" role="tabpanel" aria-labelledby="Jpills-one-example1-tab">
                        <div class="row no-gutters">
                            <div class="col mb-6 mb-md-0">
                                ...
                                <div class="form-check pl-4 pl-md-0 ml-md-4 mb-2 pb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                                    ...
                                    <label class="form-check-label mb-1" for="inlineCheckbox1">
                                        <strong>This product: </strong> Ultra Wireless S50 Headphones S50 with Bluetooth - <span class="text-red font-size-16">Tsh35.00</span>
                                    </label>
                                </div>
                                <div class="form-check pl-4 pl-md-0 ml-md-4 mb-2 pb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                                    ...
                                    <label class="form-check-label mb-1 text-blue" for="inlineCheckbox2">
                                        <span class="text-decoration-on cursor-pointer-on">Universal Headphones Case in Black</span> - <span class="text-red font-size-16">Tsh159.00</span>
                                    </label>
                                </div>
                                <div class="form-check pl-4 pl-md-0 ml-md-4 mb-2 pb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                                    ...
                                    <label class="form-check-label mb-1 text-blue" for="inlineCheckbox3">
                                        <span class="text-decoration-on cursor-pointer-on">Headphones USB Wires</span> - <span class="text-red font-size-16">Tsh50.00</span>
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-auto">
                                <div class="mr-xl-15">
                                    <div class="mb-3">
                                        <div class="text-red font-size-26 text-lh-1dot2">Tsh244.00</div>
