            ...
            <div class="d-none d-xl-block col-xl-3 col-wd-2gdot5">
                ...
                <div class="mb-6">
                    ...
                    <div class="range-slider">
                        ...
                        <!-- Range Slider -->
                        <input class="js-range-slider" type="text" data-extra-classes="u-range-slider u-range-slider-indicator u-range-slider-grid" data-type="double" data-grid="false" data-hide-from-to="true" data-prefix="Tsh" data-min="0" data-max="3456" data-from="0" data-to="3456" data-result-min="#rangeSliderExample3MinResult" data-result-max="#rangeSliderExample3MaxResult">
                        <!-- End Range Slider -->
                ...
                <div class="mb-8">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-auto">
                                    <a href="{{url('shop/single/product/width')}}" class="d-block width-75">
                                        <img class="img-fluid" src="../../assets/img/300X300/img1.jpg" alt="Image Description">
                                    </a>
                                </div>
                                <div class="col">
                                    <h3 class="text-lh-1dot2 font-size-14 mb-0"><a href="{{url('shop/single/product/width')}}">Notebook Black Spire V Nitro VN7-591G</a></h3>
                                    ...
                                    <div class="font-weight-bold">
                                        <del class="font-size-11 text-gray-9 d-block">Tsh2299.00</del>
                                        <ins class="font-size-15 text-red text-decoration-none d-block">Tsh1999.00</ins>
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="mb-4">
                            <div class="row">
                                ...
                                <div class="col">
                                    <h3 class="text-lh-1dot2 font-size-14 mb-0"><a href="{{url('shop/single/product/width')}}">Tablet Thin EliteBook Revolve 810 G6</a></h3>
                                    <div class="text-warning text-ls-n2 font-size-16 mb-1" style="width: 80px;">
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                        ...
                        <li class="mb-4">
                            <div class="row">
                                ...
                                <div class="col">
                                    <h3 class="text-lh-1dot2 font-size-14 mb-0"><a href="{{url('shop/single/product/width')}}">Notebook Purple G952VX-T7008T</a></h3>
                                    <div class="text-warning text-ls-n2 font-size-16 mb-1" style="width: 80px;">
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                        ...
                        <li class="mb-4">
                            <div class="row">
                                ...
                                <div class="col">
                                    <h3 class="text-lh-1dot2 font-size-14 mb-0"><a href="{{url('shop/single/product/width')}}">Laptop Yoga 21 80JH0035GE W8.1</a></h3>
                                    <div class="text-warning text-ls-n2 font-size-16 mb-1" style="width: 80px;">
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                            <div class="product-item__body pb-xl-2">
                                                ...
                                                <div class="mb-2">
                                                    <a href="{{url('shop/single/product/width')}}" class="d-block text-center"><img class="img-fluid" src="../../assets/img/212X200/img1.jpg" alt="Image Description"></a>
                                                </div>
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                            <div class="product-item__body pb-xl-2">
                                                ...
                                                <h5 class="mb-1 product-item__title"><a href="{{url('shop/single/product/width')}}" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                <div class="mb-2">
                                                    <a href="{{url('shop/single/product/width')}}" class="d-block text-center"><img class="img-fluid" src="../../assets/img/212X200/img2.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                                    <div class="prodcut-price">
                                                        <div class="text-gray-100">Tsh685,00</div>
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                            <div class="product-item__body pb-xl-2">
                                                ...
                                                <h5 class="mb-1 product-item__title"><a href="{{url('shop/single/product/width')}}" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                <div class="mb-2">
                                                    <a href="{{url('shop/single/product/width')}}" class="d-block text-center"><img class="img-fluid" src="../../assets/img/212X200/img3.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                                    <div class="prodcut-price">
                                                        <div class="text-gray-100">Tsh685,00</div>
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                            <div class="product-item__body pb-xl-2">
                                                ...
                                                <h5 class="mb-1 product-item__title"><a href="{{url('shop/single/product/width')}}" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                <div class="mb-2">
                                                    <a href="{{url('shop/single/product/width')}}" class="d-block text-center"><img class="img-fluid" src="../../assets/img/212X200/img4.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                                    <div class="prodcut-price">
                                                        <div class="text-gray-100">Tsh685,00</div>
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                            <div class="product-item__body pb-xl-2">
                                                ...
                                                <h5 class="mb-1 product-item__title"><a href="{{url('shop/single/product/width')}}" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                <div class="mb-2">
                                                    <a href="{{url('shop/single/product/width')}}" class="d-block text-center"><img class="img-fluid" src="../../assets/img/212X200/img5.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                                    <div class="prodcut-price">
                                                        <div class="text-gray-100">Tsh685,00</div>
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                            <div class="product-item__body pb-xl-2">
                                                ...
                                                <h5 class="mb-1 product-item__title"><a href="{{url('shop/single/product/width')}}" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                <div class="mb-2">
                                                    <a href="{{url('shop/single/product/width')}}" class="d-block text-center"><img class="img-fluid" src="../../assets/img/212X200/img6.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                                    <div class="prodcut-price">
                                                        <div class="text-gray-100">Tsh685,00</div>
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                            <div class="product-item__body pb-xl-2">
                                                ...
                                                <h5 class="mb-1 product-item__title"><a href="{{url('shop/single/product/width')}}" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                <div class="mb-2">
                                                    <a href="{{url('shop/single/product/width')}}" class="d-block text-center"><img class="img-fluid" src="../../assets/img/212X200/img7.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                                    <div class="prodcut-price">
                                                        <div class="text-gray-100">Tsh685,00</div>
                                ...
                                <div class="product-item__outer h-100">
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <h5 class="mb-1 product-item__title"><a href="{{url('shop/single/product/width')}}" class="text-blue font-weight-bold">Purple Solo 2 Wireless</a></h5>
                                            <div class="mb-2">
                                                <a href="{{url('shop/single/product/width')}}" class="d-block text-center"><img class="img-fluid" src="../../assets/img/212X200/img8.jpg" alt="Image Description"></a>
                                            </div>
                                            <div class="flex-center-between mb-1">
                                                <div class="prodcut-price">
                                                    <div class="text-gray-100">Tsh685,00</div>
